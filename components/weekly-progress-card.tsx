  ...
  return (
    <Card className="glass-card h-full">
      ...
      <CardContent className="pt-2">
        {daysTracked === 0 ? (
          <p className="text-xs text-zinc-600 italic">Sin datos esta semana</p>
        ) : (
          <>
            <div className="flex items-baseline gap-2 mb-4">
              ...
              <span className="text-[10px] text-zinc-600 uppercase font-bold tracking-widest">kcal consumidas</span>
            </div>

            <div className="space-y-2">
              <div className="flex justify-between items-center text-[11px]">
                <span className="text-zinc-500 font-bold uppercase tracking-tight">Promedio diario</span>
                <span className="text-zinc-300 font-bold">{Math.round(avgDaily)} kcal</span>
              </div>
              <div className="flex justify-between items-center text-[11px]">
                <span className="text-zinc-500 font-bold uppercase tracking-tight">Gasto total</span>
                <span className="text-zinc-300 font-bold">{Math.round(totalExpenditure).toLocaleString()} kcal</span>
              </div>
              <div className="flex justify-between items-center text-[11px]">
                <span className="text-zinc-500 font-bold uppercase tracking-tight">Balance</span>
                <span className={cn(
              ...
              <div className="flex justify-between items-center text-[11px]">
                <span className="text-zinc-500 font-bold uppercase tracking-tight">Días registrados</span>
